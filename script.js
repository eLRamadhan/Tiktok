      ...
      Swal.fire("Awas aja kalo boong!!", "", "error").then(function () {
        {
          const pertanyaan = Swal.fire({
            title: `Sasa sayang ga sama ${sender}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga sayang banget sama Sasa`).then(function () {
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang Sasa kangen ga sama ${sender}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya ${sender} juga kangen Sasa :((`).then(function () {
